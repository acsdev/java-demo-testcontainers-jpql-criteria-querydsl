...
GRANT EXECUTE ANY PROCEDURE TO hr;
GRANT CREATE ANY DIRECTORY TO hr;
GRANT ALTER SESSION TO hr;
GRANT ON COMMIT REFRESH TO hr;

ALTER USER hr quota unlimited on SYSTEM;
ALTER USER hr quota unlimited on SYSTEM;
ALTER USER hr quota unlimited on SYSTEM;
ALTER USER hr quota unlimited on SYSTEM;
ALTER USER hr default tablespace SYSTEM;
...
ALTER TABLE DEPARTMENTS
    ADD CONSTRAINT DEPT_MGR_FK FOREIGN KEY
        ( MANAGER_ID ) REFERENCES EMPLOYEES ( EMPLOYEE_ID ) NOT DEFERRABLE;
...
ALTER TABLE EMPLOYEES
    ADD CONSTRAINT EMP_DEPT_FK FOREIGN KEY
        ( DEPARTMENT_ID ) REFERENCES DEPARTMENTS ( DEPARTMENT_ID ) NOT DEFERRABLE;
